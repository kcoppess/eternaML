...
print 'loading data...'
all_inputs = np.loadtxt('single_playout_pid6502997/location_features.csv', delimiter=',') #pd.read_csv('pairmap2D.csv', delimiter=',', header=None, nrows=Ntrain)
all_labels = np.loadtxt('single_playout_pid6502997/onedim_locations.csv', delimiter=',') #pd.read_csv('loops.csv', delimiter=',', header = None, nrows=Ntrain)
