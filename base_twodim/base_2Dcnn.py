...
batch_size = 1
save = True
filename = '/Users/kcoppess/yggdrasil/eternaML/base_twodim/results/base2D'

conv_w_shapes = [ [5, 5, 3, 96], \
        [5, 5, 96, 96], \
        [5, 5, 96, 96], \
        [5, 5, 96, 96] ]
...
print 'loading data...'
all_inputs = np.loadtxt('/Users/kcoppess/yggdrasil/eternaML/single_playout_pid6502997/twobase_features.csv', delimiter=',') #pd.read_csv('pairmap2D.csv', delimiter=',', header=None, nrows=Ntrain)
